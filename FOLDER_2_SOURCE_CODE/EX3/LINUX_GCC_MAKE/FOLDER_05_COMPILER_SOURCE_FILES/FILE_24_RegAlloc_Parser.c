...
/*  A Bison parser, made from ./FOLDER_04_LEXER_PARSER_RegAlloc/RegAlloc.y
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 265 ? yytranslate[x] : 12)
...
static const char * const yytname[] = {   "$","error","$undefined.","TEMP","SPACE",
"TAB","NEWLINE","COMMA","LPAREN","RPAREN","ANY_OTHER_THING","program", NULL
};
#endif
